        ...
        <div class="details">
            ...
            <div class="mb-2 text-dark d-flex align-items-baseline gap-2">
                <h3 class="font-weight-normal text-accent mb-0">
                    {{ \App\CentralLogics\Helpers::set_symbol(($price- \App\CentralLogics\Helpers::discount_calculate($discountData, $price))) }}
                </h3>
            ...
            @if($discountData['discount'] > 0)
                <div class="mb-3 text-dark">
                    ...
                    <strong
                        id="set-discount-amount">{{ \App\CentralLogics\Helpers::set_symbol(\App\CentralLogics\Helpers::discount_calculate($discountData, $price)) }}</strong>
                </div>
            @endif
        </div>
    </div>
        ...
        <div class="col-12">
            ...
            <form id="add-to-cart-form" class="mb-2">
                ...
                <div class="d-flex justify-content-center align-items-center gap-2 mt-2">
                    <button class="btn btn-primary px-md-5 add-to-cart-button"
                            type="button">
